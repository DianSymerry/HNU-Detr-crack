...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/exp_pothole_r50/weights/best.pt', help='trained weights path')
    parser.add_argument('--batch', type=int, default=1, help='total batch size for all GPUs')
    parser.add_argument('--imgs', nargs='+', type=int, default=[736, 736], help='[height, width] image sizes')
