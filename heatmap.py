...
def get_params():
    params = {
        'weight': 'runs/train/exp_pothole_r50/weights/best.pt',  ##'weights/rtdetr-r18.pt'
        'cfg': 'ultralytics/cfg/models/rt-detr/rtdetr-r50.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'ultralytics/assets/resized_image.jpg', 'result')